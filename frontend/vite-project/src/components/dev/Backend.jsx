...
const Backend = () => {
  ...
  const handleEvaluation = async () => {
    ...
    try {
      ...
      const res = await axios.post('/api/ai/evaluate-backend', { questions, answers, spokenApproach });
  ...
  const handleBack = () => {
    if (start == true) {
      window.alert('Backend Exam Ongoing');
      return;
    }
    ...
    <div className='dsa-main'>
      ...
      <div className="dsa-top" style={{ marginBottom: '8px', borderColor: "white", backgroundColor: 'black' }}>
        <div className="dsa-header">
          ...
          <h1><span style={{ color: '#00c2fd', marginLeft: '20px', fontSize: '4vh' }}><b>BACKEND-PREP</b></span></h1>
        </div>
